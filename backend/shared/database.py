        ...
        if connected:
            ...
            async with engine.begin() as conn:
                ...
                pg_migrations = [
                    ...
                    "ALTER TABLE posts ADD COLUMN IF NOT EXISTS allow_reshare BOOLEAN DEFAULT TRUE;",
                    "ALTER TABLE posts ADD COLUMN IF NOT EXISTS allow_save BOOLEAN DEFAULT TRUE;",
                    "ALTER TABLE posts ADD COLUMN IF NOT EXISTS allow_share BOOLEAN DEFAULT TRUE;",
    ...
    if use_sqlite:
        ...
        async with engine.begin() as conn:
            ...
            for col_sql in [
                ...
                "ALTER TABLE posts ADD COLUMN allow_reshare BOOLEAN DEFAULT 1",
                "ALTER TABLE posts ADD COLUMN allow_save BOOLEAN DEFAULT 1",
                "ALTER TABLE posts ADD COLUMN allow_share BOOLEAN DEFAULT 1",
