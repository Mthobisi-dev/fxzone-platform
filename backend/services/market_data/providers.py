...
class RealDataProvider(BaseProvider):
    ...
    async def get_all_prices(self) -> Dict[str, Dict[str, Any]]:
        ...
        fallback_defaults = {
            # Crypto
            "BTCUSD": {"symbol": "BTCUSD", "price": 96450.00, "bid": 96440.00, "ask": 96460.00, "change": 1820.50, "change_pct": 1.92, "daily_change": 1820.50, "daily_change_pct": 1.92, "high": 97800.0, "low": 94100.0, "open": 94629.5, "volume": 28450000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "ETHUSD": {"symbol": "ETHUSD", "price": 2740.80, "bid": 2740.20, "ask": 2741.40, "change": 42.20, "change_pct": 1.56, "daily_change": 42.20, "daily_change_pct": 1.56, "high": 2790.0, "low": 2680.0, "open": 2698.60, "volume": 14500000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "SOLUSD": {"symbol": "SOLUSD", "price": 188.50, "bid": 188.40, "ask": 188.60, "change": 5.80, "change_pct": 3.17, "daily_change": 5.80, "daily_change_pct": 3.17, "high": 194.00, "low": 181.20, "open": 182.70, "volume": 4200000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "XRPUSD": {"symbol": "XRPUSD", "price": 2.4580, "bid": 2.4570, "ask": 2.4590, "change": 0.1240, "change_pct": 5.31, "daily_change": 0.1240, "daily_change_pct": 5.31, "high": 2.5800, "low": 2.3100, "open": 2.3340, "volume": 7800000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "ADAUSD": {"symbol": "ADAUSD", "price": 0.7850, "bid": 0.7845, "ask": 0.7855, "change": 0.0240, "change_pct": 3.15, "daily_change": 0.0240, "daily_change_pct": 3.15, "high": 0.8120, "low": 0.7550, "open": 0.7610, "volume": 1200000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "DOTUSD": {"symbol": "DOTUSD", "price": 8.4500, "bid": 8.4450, "ask": 8.4550, "change": 0.2800, "change_pct": 3.42, "daily_change": 0.2800, "daily_change_pct": 3.42, "high": 8.7500, "low": 8.1200, "open": 8.1700, "volume": 450000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            # Forex
            "EURUSD": {"symbol": "EURUSD", "price": 1.04850, "bid": 1.04845, "ask": 1.04855, "change": -0.0018, "change_pct": -0.17, "daily_change": -0.0018, "daily_change_pct": -0.17, "high": 1.0520, "low": 1.0465, "open": 1.0503, "volume": 185000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "GBPUSD": {"symbol": "GBPUSD", "price": 1.25800, "bid": 1.25790, "ask": 1.25810, "change": 0.0022, "change_pct": 0.18, "daily_change": 0.0022, "daily_change_pct": 0.18, "high": 1.2620, "low": 1.2540, "open": 1.2558, "volume": 142000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "USDJPY": {"symbol": "USDJPY", "price": 153.850, "bid": 153.840, "ask": 153.860, "change": 0.420, "change_pct": 0.27, "daily_change": 0.420, "daily_change_pct": 0.27, "high": 154.40, "low": 153.20, "open": 153.43, "volume": 165000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "AUDUSD": {"symbol": "AUDUSD", "price": 0.63500, "bid": 0.63490, "ask": 0.63510, "change": -0.0012, "change_pct": -0.19, "daily_change": -0.0012, "daily_change_pct": -0.19, "high": 0.6390, "low": 0.6330, "open": 0.6362, "volume": 95000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "USDCAD": {"symbol": "USDCAD", "price": 1.41800, "bid": 1.41790, "ask": 1.41810, "change": 0.0015, "change_pct": 0.11, "daily_change": 0.0015, "daily_change_pct": 0.11, "high": 1.4220, "low": 1.4150, "open": 1.4165, "volume": 88000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "NZDUSD": {"symbol": "NZDUSD", "price": 0.57200, "bid": 0.57190, "ask": 0.57210, "change": -0.0008, "change_pct": -0.14, "daily_change": -0.0008, "daily_change_pct": -0.14, "high": 0.5760, "low": 0.5705, "open": 0.5728, "volume": 62000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "USDCHF": {"symbol": "USDCHF", "price": 0.90200, "bid": 0.90190, "ask": 0.90210, "change": 0.0006, "change_pct": 0.07, "daily_change": 0.0006, "daily_change_pct": 0.07, "high": 0.9050, "low": 0.9005, "open": 0.9014, "volume": 75000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "EURGBP": {"symbol": "EURGBP", "price": 0.83350, "bid": 0.83340, "ask": 0.83360, "change": -0.0014, "change_pct": -0.17, "daily_change": -0.0014, "daily_change_pct": -0.17, "high": 0.8365, "low": 0.8320, "open": 0.8349, "volume": 82000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            # Commodities
            "XAUUSD": {"symbol": "XAUUSD", "price": 2892.40, "bid": 2892.10, "ask": 2892.70, "change": 18.60, "change_pct": 0.65, "daily_change": 18.60, "daily_change_pct": 0.65, "high": 2908.0, "low": 2865.0, "open": 2873.80, "volume": 42000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "XAGUSD": {"symbol": "XAGUSD", "price": 32.85, "bid": 32.82, "ask": 32.88, "change": 0.45, "change_pct": 1.39, "daily_change": 0.45, "daily_change_pct": 1.39, "high": 33.20, "low": 32.30, "open": 32.40, "volume": 18000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            # Stocks
            "AAPL": {"symbol": "AAPL", "price": 228.40, "bid": 228.35, "ask": 228.45, "change": 1.25, "change_pct": 0.55, "daily_change": 1.25, "daily_change_pct": 0.55, "high": 230.10, "low": 226.80, "open": 227.15, "volume": 48000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "NVDA": {"symbol": "NVDA", "price": 138.80, "bid": 138.75, "ask": 138.85, "change": 4.10, "change_pct": 3.04, "daily_change": 4.10, "daily_change_pct": 3.04, "high": 141.20, "low": 134.50, "open": 134.70, "volume": 72000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "TSLA": {"symbol": "TSLA", "price": 242.60, "bid": 242.50, "ask": 242.70, "change": 6.80, "change_pct": 2.88, "daily_change": 6.80, "daily_change_pct": 2.88, "high": 248.00, "low": 235.40, "open": 235.80, "volume": 65000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "MSFT": {"symbol": "MSFT", "price": 418.50, "bid": 418.40, "ask": 418.60, "change": 2.10, "change_pct": 0.50, "daily_change": 2.10, "daily_change_pct": 0.50, "high": 421.80, "low": 415.20, "open": 416.40, "volume": 22000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "GOOGL": {"symbol": "GOOGL", "price": 182.20, "bid": 182.15, "ask": 182.25, "change": 1.45, "change_pct": 0.80, "daily_change": 1.45, "daily_change_pct": 0.80, "high": 184.00, "low": 180.50, "open": 180.75, "volume": 25000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "AMZN": {"symbol": "AMZN", "price": 204.80, "bid": 204.75, "ask": 204.85, "change": 2.60, "change_pct": 1.29, "daily_change": 2.60, "daily_change_pct": 1.29, "high": 206.50, "low": 201.80, "open": 202.20, "volume": 35000000, "timestamp": datetime.now(timezone.utc).isoformat()},
            "META": {"symbol": "META", "price": 638.50, "bid": 638.40, "ask": 638.60, "change": 7.40, "change_pct": 1.17, "daily_change": 7.40, "daily_change_pct": 1.17, "high": 644.00, "low": 630.50, "open": 631.10, "volume": 18000000, "timestamp": datetime.now(timezone.utc).isoformat()},
        }
